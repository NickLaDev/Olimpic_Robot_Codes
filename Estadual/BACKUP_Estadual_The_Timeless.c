...
task sala3()
{
	...
	if(sala33==1)
	{
		...
		moveMotorTarget(esquerda,100,50);
		moveMotorTarget(direita,100,50);
		waitUntilMotorStop(esquerda);
		waitUntilMotorStop(direita);
		...
		moveMotorTarget(direita, 1000,-47);
		moveMotorTarget(esquerda, 1000,-47);
		waitUntilMotorStop(direita);
		waitUntilMotorStop(esquerda);
		...
		moveMotorTarget(direita, 1250,-47);
		moveMotorTarget(esquerda, 1250,-47);
		waitUntilMotorStop(direita);
		waitUntilMotorStop(esquerda);
	...
	if(sala33==0)
	{
		...
		if(sala33==2)
		{
			...
			*/
			...
			moveMotorTarget(direita,2300,-50);
			moveMotorTarget(esquerda,2300,-50);
			waitUntilMotorStop(direita);
			waitUntilMotorStop(esquerda);
			...
			moveMotorTarget(direita,600,-50);
			moveMotorTarget(esquerda,600,-50);
			waitUntilMotorStop(direita);
			waitUntilMotorStop(esquerda);

			moveMotorTarget(direita,565,50);
			moveMotorTarget(esquerda,565,-50);
			waitUntilMotorStop(direita);
			waitUntilMotorStop(esquerda);///////////
			...
			moveMotorTarget(direita,1100,-50);
			moveMotorTarget(esquerda,1100,-50);
			waitUntilMotorStop(direita);
			waitUntilMotorStop(esquerda);
			playSound(soundBeepBeep);
